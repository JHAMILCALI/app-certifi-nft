...
import 'package:flutter_metamask/homescreen.dart';
    ...
    return Scaffold(
      body:
          (_session == null)
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Puedes iniciar sesión con tu cuenta de Metamask para continuar',
              ...
              : Nextscreenui(walletaddress: session.accounts[0].toString()),
    );
  }
}
